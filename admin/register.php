...
if(isset($_POST['submit'])){
   ...
   if($select_tutor->rowCount() > 0){
      ...
      if($pass != $cpass){
         $message[] = 'mot de passe confirmé incorrect!';
      }else{
         $insert_tutor = $conn->prepare("INSERT INTO `tutors`(id, name, profession, email, password, image, vpass) VALUES(?,?,?,?,?,?,?)");
         $insert_tutor->execute([$id, $name, $profession, $email, $cpass, $rename, $vpass]);
      ...
      <div class="flex">
         <div class="col">
            ...
            <select name="profession" class="box" required>
               ...
               <option value="developer">data Analist</option>
         ...
         <div class="col">
            ...
            <p>votre photo <span>*</span></p>
            <input type="file" name="image" accept="image/*" required class="box">
         </div>
      </div>
      <p class="link">déjà un compte? <a href="login.php">Connecte-toi</a></p>
