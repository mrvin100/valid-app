...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_admin = $conn->prepare("INSERT INTO `admins`(id, name, profession, email, password, image, vpass) VALUES(?,?,?,?,?,?,?)");
         $insert_admin->execute([$id, $name, $profession, $email, $cpass, $rename, $vpass]);
