...
<section class="contents">
   ...
   <h1 class="heading">mes contenus</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">créer un contenu</h3>
   ...
   ?>
      <div class="box">
         <a href="view_content.php?get_id=<?= $video_id; ?>" title="voir la vidéo">
         <div class="flex">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="supprimer" class="delete-btn" onclick="return confirm('supprimer cette video?');" name="delete_video">
         </form>
      </div>
   <?php
         }
