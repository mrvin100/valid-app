...
<section class="video-form">
   ...
   <h1 class="heading">modifier la vidéo</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>changer de playlist <span>*</span></p>
      ...
      <p>changer d'image d'affiche</p>
      <input type="file" name="thumb" accept="image/*" class="box">
      <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls></video>
      <p>changer de vidéo</p>
      <input type="file" name="video" accept="video/*" class="box">
      <input type="submit" value="modifier" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">voir la vidéo</a>
         <input type="submit" value="supprimer" onclick="return confirm('supprimer cette vidéo?');" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">vidéo pas trouvé! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">ajouter une vidéo</a></p>';
      }
   ?>
