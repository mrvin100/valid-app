...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" class="thumb" alt="thumb">
   ...
   <?php
         ...
         echo '<p class="empty">aucune vidéo ajoutée! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">ajouter une vidéo</a></p>';
      }
   ?>
