...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'commentaire déja supprimé!';
   }
...
<section class="view-content">
   ...
   <?php
      ...
      echo '<p class="empty">pas encore de vidéo ajoutée! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">ajouter une vidéo</a></p>';
   }
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <?php
         ...
         echo '<p class="empty">aucun commentaire ajouté!</p>';
      }
      ?>
      </div>
